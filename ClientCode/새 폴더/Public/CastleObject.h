...
class CCastleObject final : public CPlaceableObject
{
private:
	CCastleObject(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CCastleObject(const CCastleObject& rhs);
	virtual ~CCastleObject() = default;
...
public:
	static CCastleObject* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
